...
import { deliverOrder, payOrder, payPalOrder } from '../actions/orderActions'
...
const OrderScreen = () => {
  ...
  const orderPayPal = useSelector((state) => state.orderPayPal)
  ...
  */
  ...
  const successPaymentHandler = (paymentResult) => {
    dispatch(payPalOrder(id, paymentResult))
  }
  return loading ? (
    <Loader />
  ) : error ? (
